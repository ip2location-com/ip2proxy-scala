...
myst_html_meta = {
    "description": "IP2Proxy Scala Library enables user to query an IP address if it was being used as open proxy, web proxy, VPN anonymizer and TOR exits.",
    "keywords": "IP2Proxy, Proxy, IP location, Scala",
...
html_title = "IP2Proxy Scala"

# html_baseurl = "https://ip2proxy-scala.readthedocs.io/en/latest/"